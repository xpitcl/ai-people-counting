...
MODEL_FILE="${MODEL_DIR}/resnet34_peoplenet_pruned_int8.etlt"
LABELS_FILE="${MODEL_DIR}/labels_peoplenet.txt"
MODEL_URL="https://api.ngc.nvidia.com/v2/models/nvidia/tao/peoplenet/versions/pruned_quantized_v2.3/files/resnet34_peoplenet_pruned_int8.etlt"
...
if [[ ! -s "${MODEL_FILE}" ]]; then
  ...
  echo "[INFO] Descargando PeopleNet desde NVIDIA NGC..."
